...
pub fn initialize_and_spawn(
    ...
    let handle = std::thread::Builder::new()
        ...
        .spawn(move || {
            ...
            let config_manager = super::config::ConfigManager::new(
                &*config_store,
                &*match_store,
            ...
            let match_converter =
                MatchConverter::new(&*config_store, &*match_store, &builtin_matches);
            ...
            let export_import_adapter = dispatch::executor::export_import::ExportImportHandlerAdapter::new(&modulo_manager, &paths);
